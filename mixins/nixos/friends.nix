...
in {
  ...
  users.users = {
    ...
    cdruid = (user [
      ...
      "sk-ecdsa-sha2-nistp256@openssh.com AAAAInNrLWVjZHNhLXNoYTItbmlzdHAyNTZAb3BlbnNzaC5jb20AAAAIbmlzdHAyNTYAAABBBJty+nVbrjlrQTEtJ3eEXZJRltoHAmHQH+MWMswIoY5s4uMKjd3T5AF4cs6snu6h1Swvt4OrXdONUsiZxQK7rTMAAAAEc3NoOg=="
