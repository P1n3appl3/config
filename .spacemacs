(defun dotspacemacs/layers ()
  (setq-default
   ...
   '(
     ...
     emoji themes-megapack

     ;; General programming
     (auto-completion :variables auto-completion-enable t
                      auto-completion-enable-sort-by-usage t)
     (semantic :disabled-for emacs-lisp)
     git version-control imenu-list syntax-checking

     ;; General
     evil-snipe ivy org spell-checking xkcd
     )
...
(defun dotspacemacs/user-config ()
  ...
  ;; Make spaceline look like oh-my-zsh
  ...
  ;; Don't create those .#temp files
  (setq create-lockfiles nil)

  ;; Add binding for fuzzy-finding files
...
(defun dotspacemacs/init ()
  (setq-default
   ...
   dotspacemacs-default-font '("Source Code Variable:style=Regular"
                               :size 16
                               :weight normal
                               :width normal
                               :powerline-scale 1.2)
