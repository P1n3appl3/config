local plugin_map = {
    ...
    "LnL7/vim-nix",
    "kalcutter/vim-gn",
    -- ["https://gn.googlesource.com/gn"] = { -- TODO: ftdetect not loading?
    --     config = function(p) vim.opt.rtp:append(p.dir .. "/misc/vim") end,
    -- },
...
-- treesitter is managed by nix, so it's not in the Lazy config
-- stylua: ignore
